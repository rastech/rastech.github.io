...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global: { href: '/css/home-style.css', containers: '35em', grid: { gutters: ['1.5em', 0] } },
			large: { media: '(max-width: 1680px)', href: '/css/home-style-large.css' },
			medium: { media: '(max-width: 980px)', href: '/css/home-style-medium.css', containers: '80%', viewport: { scalable: false } },
			small: { media: '(max-width: 736px)', href: '/css/home-style-small.css', grid: { gutters: ['1em', 0] } },
			xsmall: { media: '(max-width: 480px)', href: '/css/home-style-xsmall.css', containers: '100%' }
		}
	});
